    ...
    <div class="collapse navbar-collapse m-3" id="navbarNav">
      <ul class="navbar-nav">
        <li class="nav-item m-2">
          <a class="nav-link active" aria-current="page" href="<?= base_url('Control');?>">Menu Kami</a>
        </li>
        <li class="nav-item m-2">
          <a class="nav-link active" href="<?= base_url('Menu')?>" >Pasang Order</a>
        </li>
        <li class="nav-item m-2">
          <a class="nav-link active" href="<?= base_url('Order')?>" >Daftar Transaksi</a>
        </li>
        <li class="nav-item m-2">
